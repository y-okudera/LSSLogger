#
#  Be sure to run `pod spec lint LSSLogger.podspec' to ensure this is a
...
It can log to the console, the file, or both.
  ...
  # Or just: s.author    = "OkuderaYuki"
  # s.authors            = { "OkuderaYuki" => "" }
  # s.social_media_url   = "http://twitter.com/OkuderaYuki"
